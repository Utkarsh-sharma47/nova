...
require "docs/architecture/document-processing.md"
require "docs/documents/README.md"
require "docs/documents/supported-types.md"
require "docs/documents/pipeline.md"
require "docs/documents/adapters.md"
require "docs/documents/security.md"
require "docs/documents/benchmarks.md"
require "docs/testing/document-processing.md"
require "src/nova/documents/__init__.py"
require "tests/documents/test_validation.py"
...
require "alembic.ini"
require "alembic/env.py"
require "scripts/entrypoint.sh"
require "scripts/check-dockerfile.sh"
require "scripts/verify-compose.sh"
require "src/nova/api/app.py"
require "src/nova/config.py"
require "src/nova/observability/logging.py"
require "docs/deployment/local.md"
require "docs/observability/logging.md"
require "docs/observability/metrics.md"
