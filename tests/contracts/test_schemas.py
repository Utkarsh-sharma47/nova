...
from nova.contracts.common import ConfidenceBand
        ...
        **{k: ids[k] for k in ("trace_id", "document_id", "document_version_id", "shipment_id")},
        ...
        fields=[
            ExtractedField(
                ...
                evidence=Evidence(evidence_type=EvidenceType.SNIPPET, snippet="BL-1"),
...
def test_decision_result_enums() -> None:
    ...
    # RoutingRequest accepts validation payload
    RoutingRequest(
        **{k: ids[k] for k in ("trace_id", "document_id", "document_version_id", "shipment_id")},
