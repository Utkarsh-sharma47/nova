...
| [datasets.md](./datasets.md) | Done — decision fixtures landed |
| [metrics.md](./metrics.md) | Done — Router calibration target recorded |
| [regression-policy.md](./regression-policy.md) | Done — fixed decision regression suite |
...
| Extractor / Validator gold documents | Not yet (Phase 5+) |
